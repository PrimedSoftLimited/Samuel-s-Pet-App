...
import com.example.pets.DatabaseHelper;
...
public class PetProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(PetContract.PetEntry.CONTENT_AUTHORITY, PetContract.PATH_PETS, PETS);
        sUriMatcher.addURI(PetContract.PetEntry.CONTENT_AUTHORITY, PetContract.PATH_PETS + "/#", PETS_ID);
...
//     */
    ...
    private Uri insertPet(Uri uri, ContentValues values){
        ...
        uri = PetContract.PetEntry.CONTENT_URI;

//        Edit_Text new_edit = new Edit_Text();
//
//        petName = new_edit.petName;
//        petDescription = new_edit.petDescription;
//
...
//        values.put(PetContract.PetEntry.COLUMN_DESCRIPTION, descString);

        long newRowId = database.insert(PetContract.PetEntry.TABLE_NAME, null, values);

        getContext().getContentResolver().notifyChange(uri, null );

        Uri singleUri = ContentUris.withAppendedId(uri, newRowId);
...
//     */
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match){
            ...
            case PETS_ID:
                selection = PetContract.PetEntry.UID + "=?";
